...
const DoctorProfile = () => {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col lg:flex-row gap-6">
      <div className="flex-1 space-y-6">
        ...
        <div className="bg-white rounded-xl p-0 mt-4 space-y-4">
          {activeTab === "about" && (
            <>
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                ...
                eu turpis molestie, dictum est a, mattis tellus...Lorem ipsum
                dolor sit amet, consectetur adipiscing elit. Etiam eu turpis
                molestie, dictum est a, mattis tellus. Sed euismod, nisi vel
                consectetur interdum, nisl nisi consectetur nisi, euismod  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam
                eu turpis molestie, dictum est a, mattis tellus...Lorem ipsum
                dolor sit amet, consectetur adipiscing elit. Etiam eu turpis
                molestie, dictum est a, mattis tellus. Sed euismod, nisi vel
                consectetur interdum, nisl nisi consectetur nisi, euismod     
              </p>
            </>
          )}
          ...
          {activeTab === "reviews" && (
            <>
              <h2 className="text-[20px] font-dm font-semibold mb-2">Reviews</h2>
          ...
          {activeTab === "videos" && (
            <>
              <h2 className="text-[20px] font-dm font-semibold mb-2">Videos</h2>
        ...
        {/* Clinic Location - no border */}
        <div className="rounded-3xl w-[600px] mt-4 bg-white">
          <h3 className="text-[20px] font-dm font-semibold mb-2">Clinic Location</h3>
    ...
    <div className="mt-10 mb-7">
          <h2 className="text-[40px] text-500 font-dm  text-center">
            Top Treatments 
          </h2>
    ...
    <div className="-mb-10 mt-40 flex justify-center gap-6 z-10">
          <div className="w-[328px] h-[200px] bg-white border rounded-[18px] flex flex-col justify-center items-center shadow-md">
            <img src="/contactdoctor.png" className="w-[82px] h-[82px]" />
            <button className="text-sm w-[192px] h-[40px] text-[#8F6CB4] border border-[#8F6CB4] rounded-[23px] mt-3">Contact Doctor</button>
          </div>
          <div className="w-[328px] h-[200px]  bg-white border rounded-[18px] flex flex-col justify-center items-center shadow-md">
            <img src="/bookappointment.png" className="w-[82px] h-[82px]" />
            <button className="text-sm  w-[192px] h-[40px] text-[#8F6CB4] border border-[#8F6CB4] rounded-[23px] mt-3">Book Appointment</button>
          </div>
          <div className="w-[328px] h-[200px]  bg-white border rounded-[18px] flex flex-col justify-center items-center shadow-md">
            <img src="/visit.png" className="w-[82px] h-[82px]" />
            <button className="text-sm w-[192px] h-[40px] text-[#8F6CB4] border border-[#8F6CB4] rounded-[23px] mt-3">Visit</button>
          </div>
        </div> 
    </div>
